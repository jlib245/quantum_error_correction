...
(Modified for Transformer Model)
"""
...
def main(args):
    ...
    # --- 수정된 부분: Model_Transformer 임포트 ---
    from Model_Transformer import ECC_Transformer
    # --- ---
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # --- 수정된 부분: 모델 저장 로직 (DataParallel 호환) ---
...
####################################################################################################################################
    ...
    model_dir = os.path.join('Final_Results_QECCT', args.code_type, 
                             'Transformer_Code_L_' + str(args.code_L) , # FFNN -> Transformer로 변경
